    ...
    return (
        <div className="page">
            ...
            <div className="projects">
                ...
                <p>Pilot Project on Implementation of Industry 4.0 Protocols at Modern Coach Factory (MCF), Raebareli<br />
                    Rail Budget (2015) Announcement<br />
                    Mission Implementation & Coordination Committee (MICC): Notification<br />
                    Chairman, MICC-TMIR: Notification<br />
                    ToI<br />
                    Mission Vision<br />
                    Mission Extension<br />
                </p>
                <h3>Technology Mission on Railway Safety (TMRS)</h3>
                <p>Technology Mission on Railway Safety (TMRS) - Indian Railways</p>
                <h3>Wheel Impact Load Detection System (WILD)</h3>
                <p>Design and Development of Instrumentation System for Wheel-Flat Detection in Indian Railways RDSO, 2001<br />
                    Wheel Impact Load Detection System (WILD) - RDSO</p>
                <h3>Electronic Stability Program for Automobiles</h3>
                <p>Consortium project with IIT Bombay, TATA Motors, Mahindra & Mahindra, Ashok Leyland, TCS, Pricol and others on development of
                    ...
                    Electronic Stability Program for Automobiles - CAR</p>
                <h3>IITK NanoSat</h3>
                <p>Design, Development and Launch of a micro-satellite based on MEMS technology. Supported by ISRO.<br />
                    JUGNU (NanoSatellite IIT Kanpur)</p>
                <h3>B-SMART</h3>
